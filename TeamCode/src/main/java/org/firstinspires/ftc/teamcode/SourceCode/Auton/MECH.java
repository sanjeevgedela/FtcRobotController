...
//                    .splineToSplineHeading(new Pose2d(6, -29.6, Math.toRadians(180)), Math.toRadians(0))
                ...
                .lineToLinearHeading(new Pose2d(53.3, 29.6, Math.toRadians(0)))
                .UNSTABLE_addTemporalMarkerOffset(.01, () -> {
...
//                .splineToConstantHeading(new Vector2d(14, -36), Math.toRadians(0))
                ...
                .lineToLinearHeading(new Pose2d(53, 42.2, Math.toRadians(0)))
                .UNSTABLE_addTemporalMarkerOffset(.01, () -> {
                    commands.clawControl(1,1);
                })
                .waitSeconds(0.3)
...
//                    .splineToConstantHeading(new Vector2d(-28, -13), Math.toRadians(180))
                ...
                .splineToConstantHeading(new Vector2d(-48, 27.3), Math.toRadians(110))
...
//                            SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                    ...
                    .splineToConstantHeading(new Vector2d(45.4, 37 + tagDist), Math.toRadians(0))
                    .forward(6.7)
                    .UNSTABLE_addTemporalMarkerOffset(.01, () -> {
                        commands.clawControl(1,0);
                    })
