...
public class TeleOpTest3 extends LinearOpMode {
    ...
    private Vector2d targetPositionRed = new Vector2d(72, -35.2);
    private Vector2d targetPositionBlue = new Vector2d(72, 35.2);
    ...
    private void cascadinglift() {
        ...
        if (gamepad2.y) {
            ...
            leftSlide.setTargetPosition(rightSlide.getCurrentPosition() + 50);
            rightSlide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            leftSlide.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            liftControl(.5);
